table 50130 "Staging OrderTable"
{
    ...
    fields
    {
        ...
        field(25; "Is Order Created"; Boolean)
        {
        }
    }
    keys
    ...
    begin
        if ("Item No." <> '') and (Quantity > 0) and ("Unit Price" > 0) and (not "Is Order Created") then begin
            OrderProcessor.CreateOrder(Rec);
            "Is Order Created" := true;
        end;
    end;
}
